...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->Host       = 'smtp.host.tld';                      // Set the SMTP server to send through
        $mail->SMTPAuth   = true;                                  // Enable SMTP authentication
        $mail->Username   = 'contact@eurolankaweb.com';           // SMTP username
        $mail->Password   = '(uaiH;NZ?zd~'; // SMTP password (use an app password if you have 2FA enabled)
